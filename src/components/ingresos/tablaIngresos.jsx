...
const TablaIngresos = function () {
    ...
    const isShowed = showAddForm ? 'max-h-14' : 'max-h-0 overflow-hidden';
    const controlForm = showAddForm ? 'translate-x-full' : '';
    ...
    return (
        <section className="flex justify-center mx-24 my-10">
            <div className="table w-full">
                <div className="table-header-group">
                    <div className="table-row grid grid-cols-12 h-10 place-content-center rounded-t-lg bg-blackH text-center text-white font-bold">
                        ...
                        <div className="table-cell col-span-2">Tipo de Venta</div>
                    ...
                    <form onSubmit={saveData} className={`transition-max-height duration-300 delay-100 ${isShowed} table-row grid grid-cols-12 place-content-center bg-gray-50 text-center font-bold`}>
                        <div className="table-cell col-span-2"><input name="fecha" type="date" className="p-1 my-2 w-3/4 rounded-lg text-center" /></div>
                        <div className="table-cell col-span-2"><input name="canal" type="text" className="p-1 my-2 w-3/4 rounded-lg text-center" placeholder="Nombre" /></div>
                        ...
                        <div className="table-cell col-span-1"><input name="cantidad" type="Number" className="p-1 my-2 w-3/4 rounded-lg text-center" placeholder="0" onChange={(e) => setCantidad(e.target.value)} /></div>
                        ...
                        <div className="table-cell col-span-1">
                        ...
                        <div className="relative table-cell grid col-span-2 place-content-center">
